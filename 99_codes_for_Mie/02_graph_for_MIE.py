...
# === メイン処理 ===
def main():
    dat_path = "../00_Mie/data/Mie_20um_opaque_particle_05umres_z10um.dat"  # 必要に応じて変更
    out_dir = "../00_Mie/figs"  # 出力先

    # ファイル名の設定
    contour_file = "Mie_contour_20um_opaque_particle_05umres_z10um.svg"
    heatmap_file = "Mie_heatmap_20um_opaque_particle_05umres_z10um.svg"
    smooth_file = "Mie_smooth_20um_opaque_particle_05umres_z10um.svg"
